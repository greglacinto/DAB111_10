...
base_path = pathlib.Path(r'C:\Users\gregory.odiase\Documents\Greg\school work\DAB 111 - Python\projects\DAB111_10\database')
...
def data():
    ...
    # for title
    column_headers = ['highway-mpg', 'compression-ratio', 'fuel-system', 'engine-size',
